...
Copy-Item -Path (Join-Path -Path $script_dir -ChildPath "build\bin\Win32\Release\*.exe") -Destination (Join-Path -Path $script_dir -ChildPath "install") -Force -Recurse
Copy-Item -Path (Join-Path -Path $script_dir -ChildPath "build\bin\Win32\Release\*.dll") -Destination (Join-Path -Path $script_dir -ChildPath "install") -Force -Recurse
Copy-Item -Path (Join-Path -Path $script_dir -ChildPath "build\bin\x64\Release\*.exe") -Destination (Join-Path -Path $script_dir -ChildPath "install") -Force -Recurse
Copy-Item -Path (Join-Path -Path $script_dir -ChildPath "build\bin\x64\Release\*.dll") -Destination (Join-Path -Path $script_dir -ChildPath "install") -Force -Recurse
